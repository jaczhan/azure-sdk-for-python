...
class ApplicationGateway(Resource):
    ...
    :type sku: :class:`ApplicationGatewaySku
     <azure.mgmt.network.v20160601.models.ApplicationGatewaySku>`
    :param ssl_policy: SSL policy of application gateway resource
    :type ssl_policy: :class:`ApplicationGatewaySslPolicy
     <azure.mgmt.network.v20160601.models.ApplicationGatewaySslPolicy>`
    ...
    :vartype operational_state: str or
     ...
     <azure.mgmt.network.v20160601.models.ApplicationGatewayOperationalState>`
    ...
    :type gateway_ip_configurations: list of
     ...
     <azure.mgmt.network.v20160601.models.ApplicationGatewayIPConfiguration>`
    ...
    :type authentication_certificates: list of
     ...
     <azure.mgmt.network.v20160601.models.ApplicationGatewayAuthenticationCertificate>`
    ...
    :type ssl_certificates: list of :class:`ApplicationGatewaySslCertificate
     <azure.mgmt.network.v20160601.models.ApplicationGatewaySslCertificate>`
    ...
    :type frontend_ip_configurations: list of
     ...
     <azure.mgmt.network.v20160601.models.ApplicationGatewayFrontendIPConfiguration>`
    ...
    :type frontend_ports: list of :class:`ApplicationGatewayFrontendPort
     <azure.mgmt.network.v20160601.models.ApplicationGatewayFrontendPort>`
    :param probes: Probes of application gateway resource
    :type probes: list of :class:`ApplicationGatewayProbe
     <azure.mgmt.network.v20160601.models.ApplicationGatewayProbe>`
    ...
    :type backend_http_settings_collection: list of
     ...
     <azure.mgmt.network.v20160601.models.ApplicationGatewayBackendHttpSettings>`
    ...
    :type http_listeners: list of :class:`ApplicationGatewayHttpListener
     <azure.mgmt.network.v20160601.models.ApplicationGatewayHttpListener>`
    ...
    :type url_path_maps: list of :class:`ApplicationGatewayUrlPathMap
     <azure.mgmt.network.v20160601.models.ApplicationGatewayUrlPathMap>`
    ...
    :type request_routing_rules: list of
     ...
     <azure.mgmt.network.v20160601.models.ApplicationGatewayRequestRoutingRule>`
