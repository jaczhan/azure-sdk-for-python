...
class ExpressRouteCircuitsOperations(object):
    ...
    def get(
        ...
        :rtype: :class:`ExpressRouteCircuit
         <azure.mgmt.network.v20160330.models.ExpressRouteCircuit>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def list_arp_table(
        ...
        :rtype:
         ...
         <azure.mgmt.network.v20160330.models.ExpressRouteCircuitsArpTableListResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def list_routes_table(
        ...
        :rtype:
         ...
         <azure.mgmt.network.v20160330.models.ExpressRouteCircuitsRoutesTableListResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def list_routes_table_summary(
        ...
        :rtype:
         ...
         <azure.mgmt.network.v20160330.models.ExpressRouteCircuitsRoutesTableSummaryListResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def get_stats(
        ...
        :rtype: :class:`ExpressRouteCircuitStats
         <azure.mgmt.network.v20160330.models.ExpressRouteCircuitStats>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def list(
        ...
        :rtype: :class:`ExpressRouteCircuitPaged
         <azure.mgmt.network.v20160330.models.ExpressRouteCircuitPaged>`
        """
