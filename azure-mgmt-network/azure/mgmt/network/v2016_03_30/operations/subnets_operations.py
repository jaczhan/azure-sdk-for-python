...
class SubnetsOperations(object):
    ...
    def get(
        ...
        :rtype: :class:`Subnet <azure.mgmt.network.v20160330.models.Subnet>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :type subnet_parameters: :class:`Subnet
         <azure.mgmt.network.v20160330.models.Subnet>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :rtype:
    ...
    def list(
        ...
        :rtype: :class:`SubnetPaged
         <azure.mgmt.network.v20160330.models.SubnetPaged>`
        """
