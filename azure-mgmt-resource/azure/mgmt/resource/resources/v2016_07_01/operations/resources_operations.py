...
class ResourcesOperations(object):
    ...
    def move_resources(
        ...
        path_format_arguments = {
            'sourceResourceGroupName': self._serialize.url("source_resource_group_name", source_resource_group_name, 'str', pattern='^[-\w\._]+$'),
    ...
    def create_or_update(
        ...
        :type parameters: :class:`GenericResource
         <azure.mgmt.resource.resources.v20160701.models.GenericResource>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
