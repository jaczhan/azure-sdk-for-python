...
class ExpressRouteCircuit(Resource):
    ...
    :type sku: :class:`ExpressRouteCircuitSku
     <azure.mgmt.network.v20160330.models.ExpressRouteCircuitSku>`
    ...
    :type service_provider_provisioning_state: str or
     ...
     <azure.mgmt.network.v20160330.models.ServiceProviderProvisioningState>`
    ...
    :type authorizations: list of :class:`ExpressRouteCircuitAuthorization
     <azure.mgmt.network.v20160330.models.ExpressRouteCircuitAuthorization>`
    :param peerings: Gets or sets list of peerings
    :type peerings: list of :class:`ExpressRouteCircuitPeering
     <azure.mgmt.network.v20160330.models.ExpressRouteCircuitPeering>`
    ...
    :type service_provider_properties:
     ...
     <azure.mgmt.network.v20160330.models.ExpressRouteCircuitServiceProviderProperties>`
