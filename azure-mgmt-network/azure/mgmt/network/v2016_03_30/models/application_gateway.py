...
class ApplicationGateway(Resource):
    ...
    :type sku: :class:`ApplicationGatewaySku
     <azure.mgmt.network.v20160330.models.ApplicationGatewaySku>`
    ...
    :vartype operational_state: str or
     ...
     <azure.mgmt.network.v20160330.models.ApplicationGatewayOperationalState>`
    ...
    :type gateway_ip_configurations: list of
     ...
     <azure.mgmt.network.v20160330.models.ApplicationGatewayIPConfiguration>`
    ...
    :type ssl_certificates: list of :class:`ApplicationGatewaySslCertificate
     <azure.mgmt.network.v20160330.models.ApplicationGatewaySslCertificate>`
    ...
    :type frontend_ip_configurations: list of
     ...
     <azure.mgmt.network.v20160330.models.ApplicationGatewayFrontendIPConfiguration>`
    ...
    :type frontend_ports: list of :class:`ApplicationGatewayFrontendPort
     <azure.mgmt.network.v20160330.models.ApplicationGatewayFrontendPort>`
    :param probes: Gets or sets probes of application gateway resource
    :type probes: list of :class:`ApplicationGatewayProbe
     <azure.mgmt.network.v20160330.models.ApplicationGatewayProbe>`
    ...
    :type backend_address_pools: list of
     ...
     <azure.mgmt.network.v20160330.models.ApplicationGatewayBackendAddressPool>`
    ...
    :type backend_http_settings_collection: list of
     ...
     <azure.mgmt.network.v20160330.models.ApplicationGatewayBackendHttpSettings>`
    ...
    :type http_listeners: list of :class:`ApplicationGatewayHttpListener
     <azure.mgmt.network.v20160330.models.ApplicationGatewayHttpListener>`
    ...
    :type url_path_maps: list of :class:`ApplicationGatewayUrlPathMap
     <azure.mgmt.network.v20160330.models.ApplicationGatewayUrlPathMap>`
    ...
    :type request_routing_rules: list of
     ...
     <azure.mgmt.network.v20160330.models.ApplicationGatewayRequestRoutingRule>`
