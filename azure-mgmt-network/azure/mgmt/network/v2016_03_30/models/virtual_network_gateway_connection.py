...
class VirtualNetworkGatewayConnection(Resource):
    ...
    :type virtual_network_gateway1: :class:`VirtualNetworkGateway
     <azure.mgmt.network.v20160330.models.VirtualNetworkGateway>`
    ...
    :type local_network_gateway2: :class:`LocalNetworkGateway
     <azure.mgmt.network.v20160330.models.LocalNetworkGateway>`
    ...
    :type connection_type: str or :class:`VirtualNetworkGatewayConnectionType
     <azure.mgmt.network.v20160330.models.VirtualNetworkGatewayConnectionType>`
    ...
    :type connection_status: str or
     ...
     <azure.mgmt.network.v20160330.models.VirtualNetworkGatewayConnectionStatus>`
